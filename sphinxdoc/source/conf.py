...
# -*- coding: utf-8 -*-
#
# SerUt documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'serutdoc.tex', 'SerUt Documentation',
...
man_pages = [
    (master_doc, 'serutdoc', 'SerUt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'serutdoc', 'SerUt Documentation',
     author, 'serutdoc', 'Serialization utilities',
     'Miscellaneous'),
]
